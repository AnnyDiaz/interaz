...
public class usuariocontroller {
	...
	@GetMapping("/usuario/{genero}")
	public usuario getOne(@PathVariable(value = "genero") long genero) {
		return usuarioService.get(genero);
	}
	
	@GetMapping("/usuario/{rol}")
	public usuario getOne(@PathVariable(value = "rol") long rol) {
		return usuarioService.get(rol);
	}
